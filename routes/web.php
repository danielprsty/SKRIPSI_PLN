...
Route::post('set_active_menu', 'HomeController@set_active_menu')->name('set_active_menu');
Route::post('cetak_laporan', 'LaporanController@cetak_laporan')->name('cetak_laporan');
/* Auth & Profile */
