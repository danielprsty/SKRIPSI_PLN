...
<div class="row">
	...
	<div class="col-sm-6 animated fadeInRight ">
	  ...
	  <div class="form-group">
		...
		<div class="">
			<textarea class="form-control form-control-sm"  name="address">{{ $sximoconfig['address'] }}</textarea>
		 </div> 
	  </div>
	  <div class="form-group">
	    <label  class=" control-label ">Tlpn</label>
		<div class="">
			<textarea class="form-control form-control-sm"  name="no_hp">{{ $sximoconfig['no_hp'] }}</textarea>
		 </div> 
	  </div>
	  <div class="form-group">
	    <label  class=" control-label ">Atas Nama</label>
		<div class="">
			<textarea class="form-control form-control-sm"  name="atas_nama">{{ $sximoconfig['atas_nama'] }}</textarea>
		 </div> 
	  </div>  
	  ...
	  <div class="form-group">
		...
		<div class="">
			<textarea class="form-control form-control-sm"  name="nomor_rekening">{{ $sximoconfig['nomor_rekening'] }}</textarea>
		 </div> 
	  </div>
	  <div class="form-group">
	    <label  class=" control-label ">Atas Nama Rekening</label>
		<div class="">
			<textarea class="form-control form-control-sm"  name="an_no_rekening">{{ $sximoconfig['an_no_rekening'] }}</textarea>
		 </div> 
	  </div>  
