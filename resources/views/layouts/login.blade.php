        ...
        <div class="container-fluid ">
            <div class="row flex-row">
                ...
                <div class="col-md-12 my-auto p-0">
                    ...
                    <div class="login-box" style="width:30% !important;padding-top:200px">
                            ...
                            <div class="p-2 text-center"><b style="text-transform:uppercase " class="mt-2"  > {{ config('sximo.cnf_appdesc') }}  </b></div>    
