...
<div class="toolbar-nav" >   
	<div class="row">
		<div class="col-md-8"> 	
			@if($access['is_add'] ==1)
			<a href="{{ url('adminaplikasi/create?return='.$return) }}" class="btn  btn-sm"  
...
<div class="table-container">
			...
			<!-- Table Grid -->
 			...
 			{!! Form::open(array('url'=>'adminaplikasi?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'SximoTable' )) !!}
		        ...
		        <tbody>        						
		            @foreach ($rowData as $row)
		                <tr>
						 ...
						 @endforeach	
						 <td>
							<a href="{{ url('adminaplikasi/'.$row->id.'/edit?return='.$return) }}" class="btn btn-warning">Edit</a>
