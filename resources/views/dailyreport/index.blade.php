            ...
            <div class="input-group ">
                <div class="input-group-prepend">
                    <button type="button" class="btn btn-default btn-sm "
                        onclick="SximoModal('{{ url($pageModule."/search") }}','Advance Search'); "><i
                            class="fa fa-filter"></i> Filter </button>
                </div><!-- /btn-group -->
                <input type="text" class="form-control form-control-sm onsearch" data-target="{{ url($pageModule) }}"
                    aria-label="..." placeholder=" Type And Hit Enter ">
            </div>
        </div>
    </div>
...
<div class="table-container">
    ...
    <table class="table  table-hover " id="{{ $pageModule }}Table">
        ...
        <tbody>
            ...
            <tr>
                <td class="thead"> {{ ++$i }} </td>
                <td class="tcheckbox"><input type="checkbox" class="ids minimal-green" name="ids[]"
                        value="{{ $row->id }}" /> </td>
				...
				<td>
                                ...
                                <td>
							<a href="{{ url('dailyreport/'.$row->id.'/edit?return='.$return) }}" class="btn btn-warning">Edit</a>
