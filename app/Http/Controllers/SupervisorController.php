...
class SupervisorController extends Controller {
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('supervisor');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('supervisor.public.view',$data);			
			}			
		} 
		else {
			...
			return view('supervisor.public.index',$data);	
		}
