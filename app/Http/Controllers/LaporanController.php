...
class LaporanController extends Controller {
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('Laporan.public.view',$data);			
			}			
		} 
		else {
			...
			return view('Laporan.public.index',$data);	
		}
	...
	public function cetak_laporan( Request $request){
		...
		$cetak = DB::table('tb_daily_report as a')
		->select('a.*','b.first_name as leader','d.nama_cabang_divisi')
		->leftJoin('tb_users as b', 'a.id_team_leader', '=', 'b.id')
		->leftJoin('tb_team_leader as c', 'a.id_team_leader', '=', 'b.id')
		->leftJoin('tb_cabang_divisi as d', 'a.id_team_leader', '=', 'b.id')
		->where('a.tanggal_pekerjaan',$request->tanggal_pekerjaan)->get();
		return view('cetak.cetak', compact('cetak','tanggal_pekerjaan'));
	}
}
