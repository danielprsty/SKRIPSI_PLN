...
class ConfigController extends Controller
{
    ...
    public function postSave(Request $request)
    {
        ...
        if (!$validator->fails()) {
            ...
            $val  .=     "'address' 			=> '" . $request->input('address') . "',\n";
            $val  .=     "'no_hp' 			    => '" . $request->input('no_hp') . "',\n";
            $val  .=     "'atas_nama' 			=> '" . $request->input('atas_nama') . "',\n";
            $val  .=     "'nomor_rekening' 		=> '" . $request->input('nomor_rekening') . "',\n";
            $val  .=     "'an_no_rekening' 		=> '" . $request->input('an_no_rekening') . "',\n";
            $val  .=     "];\n";
