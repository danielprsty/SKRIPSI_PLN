...
class TeamleaderController extends Controller {
	...
	public $module = 'teamleader';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Teamleader();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'teamleader',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('teamleader');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('teamleader.public.view',$data);			
			}			
		} 
		else {
			...
			return view('teamleader.public.index',$data);	
		}
