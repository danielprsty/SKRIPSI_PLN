...
use App\Models\Cabangdivisi;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class CabangdivisiController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'cabangdivisi';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Cabangdivisi();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'cabangdivisi',
	...
	public static function display(  )
	{
		...
		$model  = new Cabangdivisi();
		$info = $model::makeInfo('cabangdivisi');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('cabangdivisi.public.view',$data);			
			}			
		} 
		else {
			...
			return view('cabangdivisi.public.index',$data);	
		}
